        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('openLogo')}}" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('viewcolor')}}" class="menu-link">
                    <div data-i18n="Without menu">View Color</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('addcolors')}}" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('viewsize')}}" class="menu-link">
                    <div data-i18n="Without menu">View Size</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('Addsize')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-bolt-circle"></i>
                <div data-i18n="Layouts">Discount</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('viewdis')}}" class="menu-link">
                    <div data-i18n="Without menu">View Discount</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('Adddis')}}" class="menu-link">
                    <div data-i18n="Without menu">Add Discount</div>
                  </a>
                </li>
              </ul>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{url('profiles/'.Auth::user()->profile)}}" alt style="object-fit: cover" class="w-px-60 h-100 rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="{{url('profiles/'.Auth::user()->profile)}}" alt class="w-px-40 h-auto rounded-circle" />
                            </div>
                          </div>
