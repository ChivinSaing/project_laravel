...
<div class="content-wrapper">
    ...
    <script>
        var text = "{{Session::get('update success')}}"
        Swal.fire({
            title: "Update Found",
            text,
            icon: "success"
    ...
    <script>
        var text = "{{Session::get('delete success')}}"
        Swal.fire({
            title: "Delete",
            text,
            icon: "success"
                    ...
                    <td>
                      <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('Updatecategory')}}/{{$item->id}}"><i class="bx bx-edit-alt "></i> Update</a>
